<script>
  import { showWarningModal, warningAddon, showNotification, showAddonDetails, downloadProgress } from '../stores/app.js';
  ...
  async function handleConfirm() {
    ...
    downloadProgress.set({
      isDownloading: true,
      addonId: $warningAddon.id,
      addonName: $warningAddon.name,
      current: 0,
      total: 100,
