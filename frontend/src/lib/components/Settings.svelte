      ...
      {:else if tab === 'faq'}
        ...
        <div class="bg-bg-secondary border border-border rounded-lg p-6 space-y-2">
          ...
          <details class="group bg-bg-primary border border-border rounded-lg overflow-hidden">
            ...
            <div class="px-4 pb-4 pt-1 text-sm text-text-secondary space-y-2">
              <p>
                There's no in-app report flow yet. For now, the fastest paths are:
              </p>
              <ul class="list-disc list-inside space-y-1 marker:text-accent">
                <li>Ping a maintainer in the ArcheRage community Discord.</li>
                <li>
                  Open an issue at
                  <code>github.com/ArcheRageAddons/addons</code> describing the problem.
                </li>
              </ul>
              <p>
