<script>
  ...
  async function performDownload() {
    ...
    // Close modal after a short delay so the user sees the global
    // progress modal take over from the details modal cleanly.
  ...
  async function installMissingDeps() {
    ...
    // installSerially expects { id, name } shapes — id is what's passed to
    // DownloadAddon, name is what shows in the global progress modal.
